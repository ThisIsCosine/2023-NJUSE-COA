...
public class FPUMulTest {
	...
	public void fpuMulTest1(){
		...
		assertEquals( Transformer.floatToBinary( "0.21875" ), result.toString() );
	}
	...
	public void fpuMulTest9() {
		...
		float[] input = {pZero, nZero, pInf, nInf, NAN, deNorm1, deNorm2, deNorm3, small1, small2, big1, big2, 10000000.0f, 1.2f, 1.1f, 1, 0.9f, 0.8f, 0.7f, 0.6f, 0.5f, 0.4f, 0.3f, 0.2f, 0.1f, -0.1f, -0.2f, -0.3f, -0.4f, -0.5f, -0.6f, -0.7f, -0.8f, -0.9f, -1, -10000000};
		src = new DataType(Transformer.intToBinary(Integer.toString(Float.floatToIntBits(10000000.0f))));
		dest = new DataType(Transformer.intToBinary(Integer.toString(Float.floatToIntBits(0.9f))));
		result = fpu.mul(src, dest);
		assertEquals(Transformer.intToBinary(Integer.toString(Float.floatToIntBits(10000000 * 0.9f))), result.toString());
